...
gye = LineClient(authToken="EDwesDBaKY9s9Te1tpB9.wpxkFj5fqkfJ4IOiPpoukq.5QQNT4bvy6MGCZfK459SBgzF2DNqr7IMzeMRrN/swwU=")
ais = LineClient(authToken="EDvCZsAsY1oLGR1auWX4.Ps1ICcuFfMRwOk5e/blqza.FYkwe1Fyz3WBWL3mrTbeZ8S/WX27W+jPrjV1l1rP4Nc=")
ki2 = LineClient(authToken="EDo5y05Y5EUWdmoAqggd.8FoObcuucGEyaI2x85D0pq.0KzgOXO4752Sg7TJeZQhJPGRo2i5eE3nDsky3ouGGVQ=")
ki3 = LineClient(authToken="EDN3GqAkzdHwKfiMiu0e.xb+v9leNGio/e+TRmR0T7G.oosB7BehmBM16JBRWR5+GGE51PxhrS2IJs1cPkFJ4ws=")
ki4 = LineClient(authToken="EDjkJLsTaaLF2qlvQz33.F/jlU9YrX9oyHmsSrR6a4W.UiQTW2syD6sXPHakh33wY1bqnjNPSzivXF8rlsOtPSE=")
ki5 = LineClient(authToken="EDKswPXHem3Hky2yFLS3.TEHoPZueG30AfGKoVo+mmW.lxd5BYbmdRfO7xxSwHOeTaZZwmihoZmbyTTaeHgka/0=")
ki6 = LineClient(authToken="EDwesDBaKY9s9Te1tpB9.wpxkFj5fqkfJ4IOiPpoukq.5QQNT4bvy6MGCZfK459SBgzF2DNqr7IMzeMRrN/swwU=")
ki7 = LineClient(authToken="EDc3LakXGi5SfEG23Vu2.aqCG7HhrQYqHrjtbNjJ3OG.1fo4Rz/MRq6Ue4cJMnNASdWgx/l51188JvCD4KJ0czU=")
ki8 = LineClient(authToken="EDndNA37zYbWHDdOu2d0.CNfr+h4xJlPoSgNPZSnEya.o/VHKzrgJe35CVre+D5J3vuZHljXCmhKXzfczRQMjZs=")
ki9 = LineClient(authToken="EDbs09kj2W4hBOUMwQVa.n2xhcoCgqwrUqKsByytYIG.Fb2bA2UNVDJOXLcA9V376ZJhvm0SUN6gJ7FmmNKb4Kc=")
ki10 = LineClient(authToken="EDzkQT0Q5gn7vmigKx8f.x/q1J7lwsLmFDpbupgM2JW.bENVx2VeU5ZOGQgFOsP+b2Ozhd8fGqCRr82VmA+PQCM=")
...
creator = ["ud95f6bdc6cf9adab82893ccb0b7bb30a"]
Owner = ["ud95f6bdc6cf9adab82893ccb0b7bb30a"]
admin = ["ud95f6bdc6cf9adab82893ccb0b7bb30a"]
...
#==============================================================================#
                if text.lower() == 'help':
                    ...
                    gye.sendContact(to, "ud95f6bdc6cf9adab82893ccb0b7bb30a")
                    gye.sendMessage(to,"█░░╦─╦╔╗╦─╔╗╔╗╔╦╗╔╗░░█\n█░░║║║╠─║─║─║║║║║╠─░░█\n█░░╚╩╝╚╝╚╝╚╝╚╝╩─╩╚╝░░█")
